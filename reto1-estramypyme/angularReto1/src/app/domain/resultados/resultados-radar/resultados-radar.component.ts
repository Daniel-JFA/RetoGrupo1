...
export class ResultadosRadarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.preguntaRadarService.seccion2 = Number(localStorage.getItem('nivel2')) || 0;
    ...
    this.preguntaRadarService.seccion3 = Number(localStorage.getItem('nivel3')) || 0;
    ...
    this.preguntaRadarService.seccion4 = Number(localStorage.getItem('nivel4')) || 0;
    ...
    this.preguntaRadarService.seccion5 = Number(localStorage.getItem('nivel5')) || 0;
